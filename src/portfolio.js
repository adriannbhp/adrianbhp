...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate Back-End Software Developer 🚀 having an experience of building Web API with NodeJs / Go-Lang / Python / Spring-Boot."
  ),
  resumeLink:
...
const contactInfo = {
  ...
  email_address: "adrianbimohernawanp@gmail.com"
};
